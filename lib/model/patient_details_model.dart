...
List<PatientData> patientDataFromJson(String str) => List<PatientData>.from(
    json.decode(str).map((x) => PatientData.fromJson(x)));

String patientDataToJson(List<PatientData> data) =>
