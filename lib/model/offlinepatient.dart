...
List<OfflinePatientData> offlinepatientDataFromJson(String str) =>
    List<OfflinePatientData>.from(
        json.decode(str).map((x) => OfflinePatientData.fromJson(x)));

String patientDataToJson(List<OfflinePatientData> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class OfflinePatientData {
  OfflinePatientData({
    this.id,
    this.doctorUserId,
    this.userId,
  ...
  factory OfflinePatientData.fromJson(Map<String, dynamic> json) =>
      OfflinePatientData(
        id: json["id"],
