...
// import 'Stafflist_page.dart';

// ignore: camel_case_types
class StaffSetup_page extends StatefulWidget {
  const StaffSetup_page({Key key}) : super(key: key);

  @override
  _StaffSetup_pageState createState() => _StaffSetup_pageState();
}

// ignore: camel_case_types
class _StaffSetup_pageState extends StateMVC<StaffSetup_page> {
  FunctionController staffsetupController = FunctionController();
  _StaffSetup_pageState() : super(FunctionController());
                      ...
                      child: ElevatedButton(
                          onPressed: () {
                            if (firstnameController.text == "") {
                              internaterror("Nmae can't be blank ", context);
                            } else if (lastnameController.text == "") {
                              internaterror("Name can't be blank ", context);
                            } else if (emailController.text == "") {
                              internaterror("Email can't be blank", context);
                            } else if (phonenumController.text.length != 11) {
                              internaterror(
                                  "Phone Number can't be blank", context);
                            } else if (passwordController.text == null) {
                              internaterror(
                                  "Password can't be blank ", context);
                            } else {
                              staffsetupController.stafsave(
                                  _tittleValue,
...
Widget buildUserId(userIdController, context) {
  return Padding(
